<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/devclient/Site1.Master" CodeBehind="ClientMessage.aspx.vb" Inherits="ssiFinal.ClientMessage" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="widget-body">
                    ...
                    <div class="control-group">
                        <div class="controls portlet-scroll-1">
                            <asp:GridView ID="MessagesGridView" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-advance table-hover" DataKeyNames="Id" DataSourceID="SqlDataSourceInsertConversation">
                                <Columns>
                ...
                <div class="widget-body">
                        ...
                        <div class="controls portlet-scroll-1" style="height:500px">
                            ...
                            <asp:ListView ID="ListView1" runat="server" DataKeyNames="Id" DataSourceID="SqlDataSourceViewMessages">
                                <ItemTemplate>
                                    <span style="">
                                    <strong>Sender:
                                    <asp:Label ID="SenderLabel" runat="server" Text='<%# HttpUtility.HtmlDecode(Eval("Sender"))%>' /></strong>
                                    <br />
                                    Date:
                                    <asp:Label ID="DateCreatedLabel" runat="server" Text='<%# HttpUtility.HtmlDecode(Eval("DateCreated"))%>' />
                                    <br />
                                    <br />
                                    <strong>Message:</strong><br />
                                    <asp:Label ID="MessageLabel" runat="server" Text='<%# HttpUtility.HtmlDecode(Eval("Message")).Replace(Environment.NewLine, "<br />")%>' />
                                    <br />
                                    <br />
                                    <br />
                                    <hr />
                    ...
                    <div class="control-group">
                        <div class="controls">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ReplyTextBox" ErrorMessage="Required" ValidationGroup="2"></asp:RequiredFieldValidator>
                            <br />
                            <br /><asp:Button ID="ReplyButton" runat="server" Text="Reply" CssClass="btn btn-success" ValidationGroup="2" />
                        </div>
                    </div>
                    </div>
                </div>
    ...
    <asp:SqlDataSource ID="SqlDataSourceInsertConversation" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" DeleteCommand="DELETE FROM [Conversation] WHERE [Id] = @Id" InsertCommand="INSERT INTO [Conversation] ([Sender], [Subject], [DateCreated]) VALUES (@Sender, @Subject, @DateCreated) SET @ConvoId = SCOPE_IDENTITY()" SelectCommand="SELECT Id, Sender, Subject, DateCreated FROM Conversation WHERE (Sender = @clientUserName) ORDER BY Id DESC" UpdateCommand="UPDATE [Conversation] SET [Sender] = @Sender, [Subject] = @Subject, [DateCreated] = @DateCreated WHERE [Id] = @Id">
        <DeleteParameters>
        ...
        <SelectParameters>
            <asp:SessionParameter Name="clientUserName" SessionField="clientUserName" />
        </SelectParameters>
        <UpdateParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSourceInsertMessage" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" DeleteCommand="DELETE FROM [Messages] WHERE [Id] = @Id" InsertCommand="INSERT INTO Messages(ConvoId, Sender, Message, DateCreated, Status, Receiver) VALUES (@ConvoId, @Sender, @Message, @DateCreated, @Status, 'ADMIN')" SelectCommand="SELECT * FROM [Messages]" UpdateCommand="UPDATE [Messages] SET [ConvoId] = @ConvoId, [Sender] = @Sender, [Message] = @Message, [DateCreated] = @DateCreated WHERE [Id] = @Id">
        <DeleteParameters>
            <asp:Parameter Name="Id" Type="Int32" />
        </DeleteParameters>
        <InsertParameters>
            ...
            <asp:SessionParameter Name="Sender" SessionField="clientUserName" Type="String" />
            <asp:SessionParameter Name="Message" SessionField="Message" Type="String" />
