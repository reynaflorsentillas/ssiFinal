<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/devclient/Site1.Master" CodeBehind="ClientInvoice.aspx.vb" Inherits="ssiFinal.ClientInvoice" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <script type="text/javascript">
         window.setInterval(function () {
            ...
            var chkbox = $('#<%= HiddenField1.ClientID%>').val();
    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="control-group">
                <div class="controls">
                    <h3>Others</h3>
                    <asp:GridView ID="GridViewOthers" runat="server" GridLines="Horizontal" ShowFooter="True" CssClass="table table-striped table-hover" DataSourceID="SqlDataSourceOthers" AutoGenerateColumns="False">
                        <Columns>
                            <asp:BoundField DataField="Id" HeaderText="Id" InsertVisible="False" ReadOnly="True" SortExpression="Id" Visible="False" />
                            <asp:BoundField DataField="InvoiceId" HeaderText="InvoiceId" SortExpression="InvoiceId" Visible="False" />
                            <asp:BoundField DataField="ItemType" HeaderText="ItemType" SortExpression="ItemType" Visible="False" />
                    ...
                    <div class="span4 invoice-block pull-right">
                        <ul class="unstyled amounts">
                            <li><strong>Total Charges-Storage :</strong> <asp:Label ID="LabelTotalChargesStorage" runat="server" Text="Php0.00"></asp:Label></li>
                            <li><strong>Total Charges-Item Handling :</strong> <asp:Label ID="LabelTotalChargesItemHandling" runat="server" Text="Php0.00"></asp:Label></li>
                            <li><strong>Total Charges-Special Services :</strong> <asp:Label ID="LabelTotalChargesSpecialServices" runat="server" Text="Php0.00"></asp:Label></li>
                            <li><strong>Sub Total Transactions :</strong> <asp:Label ID="LabelSubTotalCharges" runat="server" Text="Php0.00"></asp:Label></li>
                            <li><strong>Consumption Tax 12% :</strong> <asp:Label ID="LabelConsumptionTax" runat="server" Text="Php0.00"></asp:Label></li>
                            <li><strong>Grand - Total Transaction :</strong> <asp:Label ID="LabelTotalTransaction" runat="server" Text="Php0.00"></asp:Label></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <asp:SqlDataSource ID="SqlDataSourceHandlingIn" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" DeleteCommand="DELETE FROM [InvoiceItems] WHERE [Id] = @Id" SelectCommand="SELECT * FROM [InvoiceItems] WHERE (([InvoiceId] = @InvoiceId) AND ([ItemType] = @ItemType))" UpdateCommand="UPDATE [InvoiceItems] SET  [Item] = @Item, [Quantity] = @Quantity, [Rate] = @Rate WHERE [Id] = @Id">
        <DeleteParameters>
            <asp:Parameter Name="Id" Type="Int32" />
        </DeleteParameters>
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSourceMonthlyStorage" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT Department, COUNT(Department) AS Expr1 FROM MasterList WHERE (CompanyCode = @CompanyCode) AND (CreatedDate BETWEEN @From AND @To ) AND (Status = 'IN') GROUP BY Department" DataSourceMode="DataReader">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSourceInsertInvoice" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT * FROM [InvoiceList] WHERE ([CompanyName] = @CompanyName) ORDER BY [Id] DESC">
        <SelectParameters>
            <asp:SessionParameter Name="CompanyName" SessionField="CompanyName" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="SqlDataSourceMessages" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" DataSourceMode="DataReader" SelectCommand="SELECT Id, ConvoId, Sender, Message, DateCreated, Status, Receiver FROM Messages WHERE (Status = 1) AND (Receiver = @Receiver) ORDER BY Id DESC" UpdateCommand="UPDATE Messages SET Status = 0 WHERE (ConvoId = @InboxID) AND (Receiver = @Receiver)">
     ...
     <asp:SqlDataSource ID="SqlDataSourceVat" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" DataSourceMode="DataReader" DeleteCommand="DELETE FROM [InvoiceList] WHERE [Id] = @Id" InsertCommand="INSERT INTO [InvoiceList] ([CompanyName], [DateRange], [Vat]) VALUES (@CompanyName, @DateRange, @Vat)" SelectCommand="SELECT Id, Vat FROM InvoiceList WHERE (Id = @id)" UpdateCommand="UPDATE [InvoiceList] SET[Vat] = @Vat WHERE [Id] = @Id">
         <DeleteParameters>
             <asp:Parameter Name="Id" Type="Int32" />
         </DeleteParameters>
         <InsertParameters>
