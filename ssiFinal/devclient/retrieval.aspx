<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/devclient/Site1.Master" CodeBehind="retrieval.aspx.vb" Inherits="ssiFinal.retrieval" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="widget green">
                ...
                <div class="widget-body">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <asp:TextBox ID="deliveryAddressTextBox" runat="server" Height="69px" TextMode="MultiLine" CssClass="span6"></asp:TextBox>
                            <span class="help-inline">
                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="deliveryAddressTextBox" ErrorMessage="Required Field" ValidationGroup="1"></asp:RequiredFieldValidator></span>--%>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Delivery Date:</label>
                        <div class="controls">
                            <asp:TextBox ID="TextBoxDeliveryDate" runat="server" CssClass="span6"></asp:TextBox>
                            <span class="help-inline">
                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBoxDeliveryDate" ErrorMessage="Required Field" ValidationGroup="1"></asp:RequiredFieldValidator></span>--%>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="span12">
                            <div class="widget green">
                                ...
                                <div class="widget-body">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div class="table-responsive">
                                                <asp:GridView ID="GridViewAvailableBoxes" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSourceBoxesAvailable" CssClass="table table-striped table-bordered table-advance table-hover" AllowPaging="True" AllowSorting="True">
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="AddToRetrievalCheckBox" runat="server" OnCheckedChanged="AddToRetrievalCheckBox_CheckedChanged" ></asp:CheckBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <asp:Button ID="AddToRetrievalButton" runat="server" Text="Add To Retrieval List" CssClass="btn btn-primary" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="widget green">
                                ...
                                <div class="widget-body">
                                    <div class="control-group">
                                        <div class="controls">
                                            <div class="table-responsive">
                                                <asp:GridView ID="GridView1" runat="server" CssClass="table table-striped table-bordered table-advance table-hover">
                                                    <Columns>
                                                        <asp:TemplateField>
    ...
    <script>
        $(function () {
            $(<%= TextBoxDeliveryDate.ClientID%>).datepicker();
    ...
    <asp:SqlDataSource ID="SqlDataSourceGetClientInfo" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT * FROM [ClientUsers] WHERE ([username] = @username)" DataSourceMode="DataReader">
        <SelectParameters>
            <asp:SessionParameter Name="username" SessionField="clientUserName" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="SqlDataSourceBoxesAvailable" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT Id, CompanyCode, Department, BarCode, BoxNumber, Description, Status, LocationCode, DestructionDate, StockReceipt_id, QRCode, Retention, CreatedBy, CreatedDate, ModifiedBy, ModifiedDate FROM MasterList WHERE (CompanyCode = @CompanyCode) AND (Status = 'IN') ORDER BY Id DESC">
        <SelectParameters>
            <asp:SessionParameter Name="CompanyCode" SessionField="CompanyCode" Type="String" />
            <asp:Parameter DefaultValue="IN" Name="Status" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="SqlDataSourceTransHeader" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" DeleteCommand="DELETE FROM [TransactionHeaders] WHERE [Id] = @Id" InsertCommand="INSERT INTO [TransactionHeaders] ([ContactName], [username], [Address], [PickUpDate], [RequestDate], [DepartmentCode], [ContactNumber], [Status], [Type], [isRush], [CompanyCode], [CreatedBy], [CreatedDate], [ModifiedBy], [ModifiedDate], [filepathPDF], [filepathBarCode], [Alerts]) VALUES (@ContactName, @username, @Address, @PickUpDate, @RequestDate, @DepartmentCode, @ContactNumber, @Status, @Type, @isRush, @CompanyCode, @CreatedBy, @CreatedDate, @ModifiedBy, @ModifiedDate, @filepathPDF, @filepathBarCode, @Alerts) SET @transID = SCOPE_IDENTITY()" SelectCommand="SELECT * FROM [TransactionHeaders]" UpdateCommand="UPDATE [TransactionHeaders] SET [ContactName] = @ContactName, [username] = @username, [Address] = @Address, [PickUpDate] = @PickUpDate, [RequestDate] = @RequestDate, [DepartmentCode] = @DepartmentCode, [ContactNumber] = @ContactNumber, [Status] = @Status, [Type] = @Type, [isRush] = @isRush, [CompanyCode] = @CompanyCode, [CreatedBy] = @CreatedBy, [CreatedDate] = @CreatedDate, [ModifiedBy] = @ModifiedBy, [ModifiedDate] = @ModifiedDate, [filepathPDF] = @filepathPDF, [filepathBarCode] = @filepathBarCode, [Alerts] = @Alerts WHERE [Id] = @Id">
        ...
        <InsertParameters>
            ...
            <asp:SessionParameter Name="username" SessionField="clientUsername" Type="String" />
            <asp:ControlParameter ControlID="deliveryAddressTextBox" Name="Address" PropertyName="Text" Type="String" />
            <asp:ControlParameter ControlID="TextBoxDeliveryDate" Name="PickUpDate" PropertyName="Text" Type="String" />
            ...
            <asp:Parameter Name="Type" DefaultValue="RETRIEVAL" Type="String" />
            ...
            <asp:Parameter DefaultValue="" Name="filepathPDF" Type="String" />
            <asp:Parameter Name="filepathBarCode" Type="String" />
            <asp:Parameter DefaultValue="1" Name="Alerts" Type="String" />
    ...
    <asp:SqlDataSource ID="SqlDataSourceInsertRetrievalItems" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" DeleteCommand="DELETE FROM [Retrievals] WHERE [Id] = @Id" InsertCommand="INSERT INTO [Retrievals] ([TransactionHeaders_id], [BarCode], [QRCode], [Department], [BoxNumber], [Description], [Retention], [Status], [MasterList_Id], [CreatedBy], [CreatedDate], [ModifiedBy], [ModifiedDate]) VALUES (@TransactionHeaders_id, @BarCode, @QRCode, @Department, @BoxNumber, @Description, @Retention, @Status, @MasterList_Id, @CreatedBy, @CreatedDate, @ModifiedBy, @ModifiedDate)" SelectCommand="SELECT * FROM [Retrievals]" UpdateCommand="UPDATE [Retrievals] SET [TransactionHeaders_id] = @TransactionHeaders_id, [BarCode] = @BarCode, [QRCode] = @QRCode, [Department] = @Department, [BoxNumber] = @BoxNumber, [Description] = @Description, [Retention] = @Retention, [Status] = @Status, [CreatedBy] = @CreatedBy, [CreatedDate] = @CreatedDate, [ModifiedBy] = @ModifiedBy, [ModifiedDate] = @ModifiedDate WHERE [Id] = @Id">
        <DeleteParameters>
            <asp:Parameter Name="Id" Type="Int32" />
        </DeleteParameters>
        <InsertParameters>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MessagesPlaceHolder" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DataSourceMode="DataReader" SelectCommand="SELECT FirstName, LastName, email FROM ClientUsers WHERE (username = @username)">
            <SelectParameters>
