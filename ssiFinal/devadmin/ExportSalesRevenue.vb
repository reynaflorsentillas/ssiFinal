...
Public Class ExportSalesRevenue
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ssiFinal.ExportSalesRevenue.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedExportSalesRevenue
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ExportSalesRevenue = New ExportSalesRevenue()
        rpt.Site = Me.Site
        Return rpt
    End Function
