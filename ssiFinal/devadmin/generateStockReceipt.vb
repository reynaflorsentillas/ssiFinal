...
Namespace ssiFinal
	Public Class generateStockReceipt
		...
		Public Overrides Sub OnEndPage(ByVal writer As PdfWriter, ByVal doc2 As Document)
			Dim pdfPTable As iTextSharp.text.pdf.PdfPTable = New iTextSharp.text.pdf.PdfPTable(1) With
			{
		...
		Public Overrides Sub OnStartPage(ByVal writer As PdfWriter, ByVal doc2 As Document)
			...
			paragraph.Add(New Chunk("Stock Receipt Document", FontFactory.GetFont("Calibri", 15!, 1)))
