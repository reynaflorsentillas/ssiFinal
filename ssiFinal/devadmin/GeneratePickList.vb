...
Namespace ssiFinal
	Public Class GeneratePickList
		...
		Public Overrides Sub OnEndPage(ByVal writer As PdfWriter, ByVal doc2 As Document)
			...
			pdfPTable.SetWidths(New Single() { 20!, 80! })
			pdfPTable.TotalWidth = doc2.PageSize.Width
			pdfPTable.HorizontalAlignment = 1
			Dim paragraph As iTextSharp.text.Paragraph = New iTextSharp.text.Paragraph("", Me.footer)
			paragraph.Add(Environment.NewLine)
			paragraph.Add("Processed By: ")
			paragraph.Add(Environment.NewLine)
			paragraph.Add("Picked By: ")
			paragraph.Add(Environment.NewLine)
			paragraph.Add("Start Time: ")
			paragraph.Add(Environment.NewLine)
			paragraph.Add("End Time: ")
			...
			paragraph = New iTextSharp.text.Paragraph("", Me.footer)
			paragraph.Add(Environment.NewLine)
			paragraph.Add("_________________")
			paragraph.Add(Environment.NewLine)
			paragraph.Add("_________________")
			paragraph.Add(Environment.NewLine)
			paragraph.Add("_________________")
		...
		Public Overrides Sub OnStartPage(ByVal writer As PdfWriter, ByVal doc2 As Document)
			...
			paragraph.Add(New Chunk("Pick List Document", FontFactory.GetFont("Calibri", 15!, 1)))
