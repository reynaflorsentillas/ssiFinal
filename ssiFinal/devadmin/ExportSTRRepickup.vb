...
Public Class ExportSTRRepickup
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ssiFinal.ExportSTRRepickup.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedExportSTRRepickup
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ExportSTRRepickup = New ExportSTRRepickup()
        rpt.Site = Me.Site
        Return rpt
    End Function
