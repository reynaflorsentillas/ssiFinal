...
Public Class ExportSalesRevenue2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ExportSalesRevenue2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ssiFinal.ExportSalesRevenue2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedExportSalesRevenue2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ExportSalesRevenue2 = New ExportSalesRevenue2()
        rpt.Site = Me.Site
        Return rpt
    End Function
