...
Namespace ssiFinal
	Public Class changePassword
        ...
        Protected Overridable Property changePasswordTextBox As TextBox
		...
		Protected Overridable Property SqlDataSourceSelectUsers As SqlDataSource
        ...
        'Protected Async Sub SubmitButton_Click(ByVal sender As Object, ByVal e As EventArgs)
        Protected Sub SubmitButton_Click(ByVal sender As Object, ByVal e As EventArgs)
            'Dim variable As ssiFinal.changePassword.VB$StateMachine_46_SubmitButton_Click = New ssiFinal.changePassword.VB$StateMachine_46_SubmitButton_Click()
            'AsyncVoidMethodBuilder.Create().Start(Of ssiFinal.changePassword.VB$StateMachine_46_SubmitButton_Click)(variable)
        End Sub
    End Class
End Namespace