...
Namespace ssiFinal
	Public Class FAQs
        ...
        Private _ButtonDleteSection As Button
        Private _ButtonAddSection As Button
        Private _ButtonAddAnswer As Button

        Protected Overridable Property ButtonAddAnswer As Button
            Get
                Return Me._ButtonAddAnswer
            End Get
            <MethodImpl(MethodImplOptions.Synchronized)>
            Set(ByVal value As System.Web.UI.WebControls.Button)
                Dim eventHandler As System.EventHandler = New System.EventHandler(AddressOf Me.ButtonAddAnswer_Click)
                Dim button As System.Web.UI.WebControls.Button = Me._ButtonAddAnswer
                If (button IsNot Nothing) Then
                    RemoveHandler button.Click, eventHandler
                End If
                Me._ButtonAddAnswer = value
                button = Me._ButtonAddAnswer
                If (button IsNot Nothing) Then
        ...
        Protected Overridable Property ButtonAddSection As Button
			Get
				Return Me._ButtonAddSection
			End Get
			<MethodImpl(MethodImplOptions.Synchronized)>
			Set(ByVal value As System.Web.UI.WebControls.Button)
				Dim eventHandler As System.EventHandler = New System.EventHandler(AddressOf Me.ButtonAddSection_Click)
				Dim button As System.Web.UI.WebControls.Button = Me._ButtonAddSection
				If (button IsNot Nothing) Then
					RemoveHandler button.Click,  eventHandler
				End If
				Me._ButtonAddSection = value
				button = Me._ButtonAddSection
				If (button IsNot Nothing) Then
					AddHandler button.Click,  eventHandler
				End If
			End Set
		...
		Protected Overridable Property ButtonDleteSection As Button
			Get
				Return Me._ButtonDleteSection
			End Get
			<MethodImpl(MethodImplOptions.Synchronized)>
			Set(ByVal value As System.Web.UI.WebControls.Button)
				Dim eventHandler As System.EventHandler = New System.EventHandler(AddressOf Me.ButtonDleteSection_Click)
				Dim button As System.Web.UI.WebControls.Button = Me._ButtonDleteSection
				If (button IsNot Nothing) Then
					RemoveHandler button.Click,  eventHandler
				End If
				Me._ButtonDleteSection = value
				button = Me._ButtonDleteSection
				If (button IsNot Nothing) Then
					AddHandler button.Click,  eventHandler
				End If
			End Set
		...
		Protected Overridable Property DropDownListFaqs As DropDownList

		Protected Overridable Property GridViewAnwers As GridView
		...
		Protected Overridable Property SqlDataSourceAnswers As SqlDataSource

		Protected Overridable Property SqlDataSourceDeleteAllAnswers As SqlDataSource

		Protected Overridable Property SqlDataSourceMessages As SqlDataSource

		Protected Overridable Property SqlDataSourceSections As SqlDataSource

		Protected Overridable Property SqlDataSourceUserLoginAlert As SqlDataSource

		Protected Overridable Property TextBoxAnswer As TextBox

		Protected Overridable Property TextBoxQuestion As TextBox

		Protected Overridable Property TextBoxSectionName As TextBox
		...
		Protected Sub ButtonAddAnswer_Click(ByVal sender As Object, ByVal e As EventArgs)
			Me.SqlDataSourceAnswers.Insert()
			Me.TextBoxAnswer.Text = ""
			Me.TextBoxQuestion.Text = ""
		End Sub

		Protected Sub ButtonAddSection_Click(ByVal sender As Object, ByVal e As EventArgs)
			Me.SqlDataSourceSections.Insert()
			Me.TextBoxSectionName.Text = ""
		End Sub

		Protected Sub ButtonDleteSection_Click(ByVal sender As Object, ByVal e As EventArgs)
			Try
				Me.SqlDataSourceSections.Delete()
				MyBase.Response.Redirect("FAQs")
			Catch exception As System.Exception
				ProjectData.SetProjectError(exception)
				ProjectData.ClearProjectError()
			End Try
		...
		Protected Sub LinkButtonDeleteAll_Click(ByVal sender As Object, ByVal e As EventArgs)
			Me.SqlDataSourceDeleteAllAnswers.Delete()
			Me.GridViewAnwers.DataBind()
		End Sub
