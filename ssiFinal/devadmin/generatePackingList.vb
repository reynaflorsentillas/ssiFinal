...
Namespace ssiFinal
	Public Class generatePackingList
		...
		Public Overrides Sub OnEndPage(ByVal writer As PdfWriter, ByVal doc As Document)
			...
			paragraph.Add(Environment.NewLine)
			paragraph.Add(Environment.NewLine)
			paragraph.Add("__________________________________")
			paragraph.Add(Environment.NewLine)
			...
			pdfPTable.AddCell(pdfPCell)
			pdfPTable.WriteSelectedRows(0, -1, 0!, doc.BottomMargin + 50!, writer.DirectContent)
		End Sub
		...
		Public Overrides Sub OnStartPage(ByVal writer As PdfWriter, ByVal doc As Document)
			...
			Dim paragraph As iTextSharp.text.Paragraph = New iTextSharp.text.Paragraph() With
			{
				.Alignment = 1
			}
			paragraph.Add(New Chunk("Packing List", FontFactory.GetFont("Calibri", 15!, 1)))
			...
			pdfPTable.WriteSelectedRows(0, -1, 0!, doc.PageSize.Height - 10!, writer.DirectContent)
			pdfPTable1.WriteSelectedRows(0, -1, 0!, doc.PageSize.Height - 100!, writer.DirectContent)
		End Sub
	End Class
End Namespace