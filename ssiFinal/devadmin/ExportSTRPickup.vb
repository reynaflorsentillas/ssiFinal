...
Public Class ExportSTRPickup
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ssiFinal.ExportSTRPickup.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedExportSTRPickup
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ExportSTRPickup = New ExportSTRPickup()
        rpt.Site = Me.Site
        Return rpt
    End Function
