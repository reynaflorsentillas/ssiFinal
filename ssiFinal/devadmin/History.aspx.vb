		...
		Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs)
			Try
				If (Me.SearchDropDownList.SelectedIndex = 0) Then
					Me.SqlDataSourceHistory.FilterExpression = String.Concat("CreatedDate = '", Me.SearchTextBox.Text.Trim(), "'")
				ElseIf (Me.SearchDropDownList.SelectedIndex = 1) Then
					Me.SqlDataSourceHistory.FilterExpression = String.Concat("Description Like '%", Me.SearchTextBox.Text.Trim(), "%'")
				ElseIf (Me.SearchDropDownList.SelectedIndex = 2) Then
					Me.SqlDataSourceHistory.FilterExpression = String.Concat("CreatedBy Like '%", Me.SearchTextBox.Text.Trim(), "%'")
				ElseIf (Me.SearchDropDownList.SelectedIndex = 3) Then
					Me.SqlDataSourceHistory.FilterExpression = String.Concat("MasterListId = '", Me.SearchTextBox.Text.Trim(), "'")
				End If
				Me.SqlDataSourceHistory.[Select](DataSourceSelectArguments.Empty)
			Catch exception As System.Exception
				ProjectData.SetProjectError(exception)
				ProjectData.ClearProjectError()
			End Try
