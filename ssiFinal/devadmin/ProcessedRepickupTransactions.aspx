<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/devadmin/MasterPage.Master" CodeBehind="ProcessedRepickupTransactions.aspx.vb" Inherits="ssiFinal.ProcessedRepickupTransactions" %>
                ...
                <div class="widget-body">
                    ...
                    <div class="control-group">
                        <div class="controls portlet-scroll-1" style="height: 500px; border: 2px solid grey;">
                            <asp:GridView ID="TransactionPickupsGridView" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSourceTransactionRepickupGrid" AllowPaging="True" AllowSorting="True" CssClass="table table-striped table-bordered table-advance table-hover">
                                <Columns>
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <div class="table-responsive">
                                <asp:DetailsView ID="TransactionPickupDetailsView" runat="server" AutoGenerateRows="False" DataKeyNames="Id" DataSourceID="SqlDataSourceTransactionRepickupDetails" Height="50px" Width="329px" CssClass="table table-striped table-bordered table-advance table-hover">
                                    <Fields>
                ...
                <div class="widget-body">
                    ...
                    <div class="control-group">
                        <div class="controls">
                            ...
                            <asp:Button ID="ButtonDownloadStockReceiptExcel" runat="server" Text="Download Stock Receipt EXCEL" CssClass="btn btn-primary" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="span12">
            <div class="widget green">
                ...
                <div class="widget-body">
                    ...
                    <div class="control-group">
                        <div class="controls portlet-scroll-1" style="height:500px;border: 2px solid grey;">
                                <asp:GridView ID="TransactionPickupItemsGridView" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSourcetransactionRepickupItems" CssClass="table table-striped table-bordered table-advance table-hover" AllowSorting="True">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Retention" HeaderText="Retention" SortExpression="Retention" DataFormatString="{0:dd/MM/yyyy}" />
                                        <asp:BoundField DataField="Status" HeaderText="Status" SortExpression="Status" />
                                        <asp:BoundField DataField="CreatedBy" HeaderText="CreatedBy" SortExpression="CreatedBy" Visible="False" />
                                        <asp:BoundField DataField="CreatedDate" HeaderText="CreatedDate" SortExpression="CreatedDate" Visible="False" />
                                        <asp:BoundField DataField="ModifiedBy" HeaderText="ModifiedBy" SortExpression="ModifiedBy" Visible="False" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSourcetransactionRepickupItems" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT * FROM [Repickup] WHERE (([Status] = @Status) AND ([TransactionHeaders_id] = @TransactionHeaders_id))">
                                    <SelectParameters>
                                        <asp:QueryStringParameter DefaultValue="PROCESSED" Name="Status" QueryStringField="Status" Type="String" />
