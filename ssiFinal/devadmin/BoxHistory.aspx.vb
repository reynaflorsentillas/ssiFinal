...
Namespace ssiFinal
	Public Class BoxHistory
        ...
        Protected Overridable Property GridViewDetails As GridView
        ...
        Protected Overridable Property MasterListGridView As GridView
			...
			Set(ByVal value As System.Web.UI.WebControls.GridView)
				Dim gridViewRowEventHandler As System.Web.UI.WebControls.GridViewRowEventHandler = New System.Web.UI.WebControls.GridViewRowEventHandler(AddressOf Me.MasterListGridView_RowDataBound)
		...
		Private Sub MasterListGridView_RowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs)
			If (e.Row.RowType = DataControlRowType.DataRow) Then
				Dim label As System.Web.UI.WebControls.Label = DirectCast(e.Row.FindControl("Label1"), System.Web.UI.WebControls.Label)
				If (Operators.CompareString(label.Text, "1", False) = 0) Then
					label.Text = "Yes"
					Return
				End If
				label.Text = "No"
