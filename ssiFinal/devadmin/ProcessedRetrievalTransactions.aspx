<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/devadmin/MasterPage.Master" CodeBehind="ProcessedRetrievalTransactions.aspx.vb" Inherits="ssiFinal.ProcessedRetrievalTransactions" %>
                ...
                <div class="widget-body">
                    ...
                    <div class="control-group">
                        <div class="controls portlet-scroll-1" style="height:500px;border: 2px solid grey;">
                                <asp:GridView ID="TransactionRetrievalGridView" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSourceTransactionRetrievalGrid" CssClass="table table-striped table-bordered table-advance table-hover" AllowSorting="True" AllowPaging="True">
                                    <Columns>
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <div class="table-responsive">
                                <asp:DetailsView ID="TransactionRetrievalDetailsView" runat="server" AutoGenerateRows="False" DataKeyNames="Id" DataSourceID="SqlDataSourceTransactionRetrievalDetails" Height="50px" Width="431px" CssClass="table table-striped table-bordered table-advance table-hover">
                                    <Fields>
                                        <asp:BoundField DataField="Id" HeaderText="Id" InsertVisible="False" ReadOnly="True" SortExpression="Id" />
        ...
        <div class="span12">
            <div class="widget green">
                ...
                <div class="widget-body">
                    ...
                    <div class="control-group">
                        <div class="controls">
                             <asp:Button ID="Button1" runat="server" Text="Download Delivery Receipt" CssClass="btn btn-primary" />
                            <%--<asp:Button ID="Button2" runat="server" Text="Download Pick List" CssClass="btn btn-primary" />--%>
                            </div>
                        </div>
                </div>
            </div>
                ...
                <div class="widget-body">
                    ...
                    <div class="control-group">
                        <div class="controls portlet-scroll-1" style="height:700px;border: 2px solid grey;">
                                <asp:GridView ID="TransactionRetrievalItemsGridView" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSourceTransactionRetrievalItems" CssClass="table table-striped table-bordered table-advance table-hover" AllowSorting="True">
                                    <Columns>
                                        <asp:BoundField DataField="Id" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="Id" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSourceTransactionRetrievalItems" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT Id,TransactionHeaders_id, BarCode, QRCode, Department, BoxNumber, Description, Retention, Status, MasterList_Id, CreatedBy, CreatedDate, ModifiedBy, ModifiedDate FROM Retrievals WHERE (Status = @Status) AND (TransactionHeaders_id = @TransactionHeaders_id)">
                                    <SelectParameters>
                                        <asp:QueryStringParameter DefaultValue="PROCESSED" Name="Status" QueryStringField="Status" Type="String" />
                                        <asp:ControlParameter ControlID="TransactionRetrievalGridView" DefaultValue="" Name="TransactionHeaders_id" PropertyName="SelectedValue" Type="Int32" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                            <asp:SqlDataSource ID="SqlDataSourceReadMasterList" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" DataSourceMode="DataReader" SelectCommand="SELECT Id, CompanyCode, Department, BarCode, BoxNumber, Description, Status, LocationCode, DestructionDate, StockReceipt_id, QRCode, Retention, CreatedBy, CreatedDate, ModifiedBy, ModifiedDate FROM MasterList WHERE (StockReceipt_id = @StockReceipt_id) AND (Status = 'OUT')">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="TransactionRetrievalDetailsView" Name="StockReceipt_id" PropertyName="SelectedValue" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
