...
Namespace ssiFinal
	Public Class addDepartment
        ...
        Private _addDepartment As HtmlButton

        Protected Overridable Property addDepartment As HtmlButton
            Get
                Return Me._addDepartment
            End Get
            <MethodImpl(MethodImplOptions.Synchronized)>
            Set(ByVal value As System.Web.UI.HtmlControls.HtmlButton)
                Dim eventHandler As System.EventHandler = New System.EventHandler(AddressOf Me.addDepartment_ServerClick)
                Dim htmlButton As System.Web.UI.HtmlControls.HtmlButton = Me._addDepartment
                If (htmlButton IsNot Nothing) Then
                    RemoveHandler htmlButton.ServerClick, eventHandler
                End If
                Me._addDepartment = value
                htmlButton = Me._addDepartment
                If (htmlButton IsNot Nothing) Then
		...
		Public Sub New()
			...
			Me.totalBoxesCount = 0
		End Sub

		Private Sub addDepartment_ServerClick(ByVal sender As Object, ByVal e As EventArgs)
			Try
				Me.Validate()
				If (MyBase.IsValid) Then
					...
					Me.SqlDataSourceDepartmentList.Insert()
					Me.TextBox1.Text = ""
					Me.TextBox2.Text = ""
					MyBase.Response.Redirect("SuccessPage?SuccessMessage=New Department has been successfully submitted.")
				End If
		...
		Protected Sub DropDownList1_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs)
			Try
				Me.SqlDataSourceDepartmentList.[Select](DataSourceSelectArguments.Empty)
			Catch exception As System.Exception
				ProjectData.SetProjectError(exception)
				ProjectData.ClearProjectError()
			End Try
